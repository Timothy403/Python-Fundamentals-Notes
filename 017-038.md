...
I do not like how I can see the check code and it obscures showing how the function is being called. I want to be able to clearly see where you position your arguments at a glance (['a', 'b'], 'b')
(['a', 'b'], 'b'), ['a'])       the final [a] was confusing
